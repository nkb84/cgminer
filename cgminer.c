...
#if defined(HAVE_OPENCL) && defined(USE_SCRYPT)
#include "scrypt.h"
#endif
#ifdef USE_USBUTILS
#include "usbutils.h"
...
#ifdef USE_USBUTILS
	cg_mvwprintw(statuswin, devcursor - 1, 1, "[U]SB management [P]ool management %s[S]ettings [D]isplay options [Q]uit",
